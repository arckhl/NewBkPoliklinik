...
<body>
    ...
    <div class="login-container">
        <div class="left-container">
            <img src="assets/images/logo_poli.png" alt="Login Image">
        </div>
        <div class="right-container">
            <div class="login-form">
                <h4 class="text-center">Login</h4>
                <p class="login-box-msg text-center">Sebagai <b class="text-success">PASIEN</b></p>
                <br><br>
            ...
            <div class="text-center mt-3">
                <a href="register.php"><span class="text-primary">Belum Punya Akun?</span></a>
            </div>
        </div>
    </div>
