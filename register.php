...
<body>
    <div class="login-container">
        <div class="left-container">
            <img src="assets/images/logoregister.png" alt="Login Image">
        </div>
        <div class="right-container">
            <div class="login-form">
                <br><br><br>
                <h4 class="text-center">Pendaftaran Pasien Disini </h4>
                <p class="login-box-msg text-center">Isi Data Diri <span
